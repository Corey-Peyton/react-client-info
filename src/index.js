...
const Network = () => {
  ...
  const handleChange = ({
    target: { effectiveType, downlink, downlinkMax },
  }) => {
  ...
  return (
    <>
      {connection.effectiveType} ({connection.downlink} up to{" "}
  ...
  useEffect(() => {
    const intervalId = setInterval(() => {
      setDatetime2((datetime2) =>
        dateFormat(new Date(), "dddd, mmmm dS, yyyy, HH:MM:ss")
      );
    }, 1000);
  ...
  if (isMobileOnly || isTablet) {
    mobileDevice = (
      <Typography variant="subtitle1" display="block">
        <DevicesOtherIcon style={{ color: "#0275d8" }} />
        &nbsp;&nbsp;{mobileModel}
      </Typography>
    );
  }
    ...
    <Card className={classes.card}>
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        <CardContent>
          ...
          <Typography variant="subtitle1" display="block">
            <strong>
              <span style={{ color: "#0275d8" }}>OS</span>
            </strong>
            &nbsp;&nbsp;{osName} {osVersion} ({platform})
          </Typography>
          <Typography variant="subtitle1" display="block">
            <LanguageIcon style={{ color: "#0275d8" }} />
            &nbsp;&nbsp;{browserName} {browserVersion}
          </Typography>
          {mobileDevice}
          <Typography variant="subtitle1" display="block">
            <BatteryUnknownIcon style={{ color: "#0275d8" }} />
            &nbsp;&nbsp;{batteryLevel}
          </Typography>
          <Typography variant="subtitle1" display="block">
            <NetworkCellIcon style={{ color: "#0275d8" }} />
            &nbsp;&nbsp;{networkInfo}
          </Typography>
          <Typography variant="subtitle1" display="block">
            <MemoryIcon style={{ color: "#0275d8" }} />
            &nbsp;&nbsp;{memoryDevice} GB
          </Typography>
        </CardContent>
      </Collapse>
...
function SvgIconsSize() {
  ...
  return (
    <React.Fragment>
        ...
        <div className={classes.menu}>
          ...
          >
            <IconButton className={classes.icon}>
              &nbsp;
              <DashboardTwoToneIcon style={{ color: "#0275d8" }} />
              &nbsp;
              <strong>
                <span style={{ color: "#0275d8", fontSize: "18px" }}>
                  Service
                </span>
              </strong>
            </IconButton>
          ...
          >
            <IconButton className={classes.icon}>
              &nbsp;
              <FilterDramaTwoToneIcon style={{ color: "#5cb85c" }} />
              &nbsp;
              <strong>
                <span style={{ color: "#5cb85c", fontSize: "18px" }}>
                  Product
                </span>
              </strong>
            </IconButton>
          ...
          >
            <IconButton className={classes.icon}>
              &nbsp;
              <FaceTwoToneIcon style={{ color: "#f0ad4e" }} />
              &nbsp;
              <strong>
      ...
      <CssBaseline />
      <Container maxWidth="lg">{custInfo}</Container>
    </React.Fragment>
  );
}
